    ...
    const data = [
        {
            ...
            description: 'Java, JavaScript, React, HTML, CSS, MongoDB, GitHub',
        },
        {
            name: 'Education',
        ...
        },
        {
            ...
            description: 'Senior Executive at IndiGo Airlines',
        },
    ];
    return (
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am an aspiring software developer with a strong foundation in full-stack development.  I'm currently at Scaler Academy mastering Data Structures, Algorithms, Java, Spring Boot, and system design. And also Leveraging GitHub Copilot as a development accelerator while maintaining code ownership and quality. </p>
